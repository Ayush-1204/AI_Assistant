                      ...
                      return Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('No notes found.', style: TextStyle(color: Colors.white.withValues(alpha: 0.5))),
                          ],
                        )
                      );
                    }
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Icon(Icons.description, size: 16, color: Colors.white.withValues(alpha: 0.7)),
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text('AI Research', style: TextStyle(fontSize: 10, color: Colors.white.withValues(alpha: 0.7))),
                              ),
                              const Spacer(),
                              Text('Just now', style: TextStyle(color: Colors.white.withValues(alpha: 0.3), fontSize: 11)),
                            ],
                          )
                        ],
                      ),
